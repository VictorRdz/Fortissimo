...
public class CursoJP extends JPanel {
   ...
   // ***MODIFICAR UNICAMENTE MEDIANTE EL GUI BUILDER DE NETBEANS***
    ...
    private void formMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMousePressed
        if(Main.Alumno.Plus.isVisible()) {
            Main.Alumno.Plus.cursoPresionado(this.idCurso);
        }
        else if(Main.Alumno.Info.isVisible()) {
            Main.Alumno.Info.cursoPresionado(this.idCurso);
        }
