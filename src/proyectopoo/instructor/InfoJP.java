...
public class InfoJP extends javax.swing.JPanel {
    ...
    public InfoJP(Object[] datos, int numCurso) {
        ...
        idInstructor = (int) datos[0];
        obtenerCursos();
        obtenerCursoJP();
        initComponents();
        InformacionCurso.setVisible(false);
        AlumnosInscritos.setVisible(false);
        if(numCurso == 0)
    ...
    private void initComponents() {
        ...
        AlumnosInscritos = new javax.swing.JPanel();
        jPanel4 = new javax.swing.JPanel();
        jLabel5 = new javax.swing.JLabel();
        jScrollPane3 = new javax.swing.JScrollPane();
        jPanel5 = new javax.swing.JPanel();
        jButton5 = new javax.swing.JButton();
        CursosImpartidos = new javax.swing.JPanel();
        ...
        jPanel3.setBackground(new java.awt.Color(49, 78, 106));
        jPanel3.setPreferredSize(new java.awt.Dimension(891, 78));
        ...
        jLabel3.setMinimumSize(new java.awt.Dimension(0, 49));
        jPanel3.add(jLabel3, new java.awt.GridBagConstraints());

        InformacionCurso.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 70));
        ...
        jLabel4.setText("Precio (MXN):");
        InformacionCurso.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 140, -1, -1));
        ...
        InformacionCurso.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 170, 330, 150));
        ...
        InformacionCurso.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, 80, 50));

        jButton4.setText("Ver alumnos");
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4ActionPerformed(evt);
            }
        });
        InformacionCurso.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 400, 130, 50));

        add(InformacionCurso, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        AlumnosInscritos.setBackground(new java.awt.Color(24, 24, 24));
        AlumnosInscritos.setPreferredSize(new java.awt.Dimension(891, 483));
        AlumnosInscritos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel4.setBackground(new java.awt.Color(49, 78, 106));
        jPanel4.setPreferredSize(new java.awt.Dimension(891, 70));
        jPanel4.setLayout(new java.awt.GridBagLayout());

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 40)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Alumnos Inscritos");
        jLabel5.setMinimumSize(new java.awt.Dimension(0, 49));
        jPanel4.add(jLabel5, new java.awt.GridBagConstraints());

        AlumnosInscritos.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 70));

        jPanel5.setBackground(new java.awt.Color(24, 24, 24));
        jScrollPane3.setViewportView(jPanel5);

        AlumnosInscritos.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 100, 790, 320));
        ...
        AlumnosInscritos.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 440, 80, 30));

        add(AlumnosInscritos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        CursosImpartidos.setBackground(new java.awt.Color(24, 24, 24));
        CursosImpartidos.setPreferredSize(new java.awt.Dimension(891, 483));
        CursosImpartidos.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jPanel1.setBackground(new java.awt.Color(49, 78, 106));
        jPanel1.setPreferredSize(new java.awt.Dimension(891, 70));
        ...
        CursosImpartidos.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 70));

        jScrollPane1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);

        jPanel2.setBackground(new java.awt.Color(24, 24, 24));
        jPanel2.setPreferredSize(new java.awt.Dimension(810, 500));
        ...
        CursosImpartidos.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 100, 810, 320));
        ...
        CursosImpartidos.add(anteriorJB, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 430, -1, -1));
        ...
        CursosImpartidos.add(siguienteJB, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 430, -1, -1));

        add(CursosImpartidos, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private void anteriorJBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_anteriorJBActionPerformed
        ...
        Main.Instructor.actualizarInfo(numCurso);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        InformacionCurso.setVisible(false);
        CursosImpartidos.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        InformacionCurso.setVisible(false);
        CursosImpartidos.setVisible(false);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int opcion = JOptionPane.showOptionDialog(null, "¿Está seguro que quiere eliminar el curso?", "Confirmación",
                JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE,
                null, opciones, opciones[0]);
        if(opcion == 0) {
            Connection conn = BD.getConnection();
            if(conn != null) {
                BD.eliminarCurso(conn, idCurso);
            }
            BD.closeConnection(conn);
    ...
    private void obtenerCursos() {
        Connection conn = BD.getConnection();
        if(conn != null) {
            idCursos = BD.getCursosInst(conn, idInstructor);
        }
        BD.closeConnection(conn);
    } 
    ...
    public void getDatos(int ID) {
        ...
        if(conn != null) {
            ...
            jLabel3.setText((String) datosCurso[10]);
    ...
    public void crearTabla() {
        Connection conn = BD.getConnection();
        if(conn != null) {
            BD.obtenerAlumnos(conn, modeloTabla, idCurso);
        }
        BD.closeConnection(conn);
    ...
    private javax.swing.JPanel AlumnosInscritos;
    private javax.swing.JPanel CursosImpartidos;
    ...
    private DefaultTableModel modeloTabla = new DefaultTableModel(new String[] {"ID", "Nombre", "Usuario", "Correo"}, 0);
