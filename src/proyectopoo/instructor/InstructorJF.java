...
public class InstructorJF extends JFrame {


    public InstructorJF(int id) {
        getDatos(id);
        initComponents();
        crearPaneles();
        ajustarPaneles();
   ...
   // ***MODIFICAR UNICAMENTE MEDIANTE EL GUI BUILDER DE NETBEANS***
    ...
    private void initComponents() {
        ...
        setTitle("Fortissimo");
        BarraSuperiorJP.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, -1, -1));
    ...
    private void exitJPMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exitJPMousePressed
        ...
        switch(opcion) {
            ...
            case 1:
                ...
                Main.Instructor.setVisible(false);
        }
    ...
    public void actualizar() {
        ...
        switch(visible) {
            case 2:
                Main.Instructor.Home.setVisible(false);
                Main.Instructor.Info.setVisible(true);
                break;
            case 3:
                Main.Instructor.Home.setVisible(false);
                Main.Instructor.Plus.setVisible(true);
                break;
            case 4:
                Main.Instructor.Home.setVisible(false);
                Main.Instructor.User.setVisible(true);
                break;
            default:
        }
    }
    ...
    private void getDatos(int ID) {
        ...
        if(conn != null) {
            almacenarDatos(BD.getDatosPersona(conn, ID, BD.INSTRUCTOR));
        } 
