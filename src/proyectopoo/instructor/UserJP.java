...
public class UserJP extends JPanel {
    ...
    private void actualizarDatos(Connection conn) {
        String actualizarRegistro = "UPDATE instructor SET nombreInstructor = ?, apellidoInstructor = ?, "
                + "generoInstructor = ?, nacimientoInstructor = ?, celularInstructor = ?, contraseñaInstructor = ?, "
                + "paisInstructor = ?, estadoInstructor = ?, municipioInstructor = ? "
                + "WHERE idInstructor = ?";
